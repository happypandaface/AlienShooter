...
public class MainMenu implements SpaceScene {
	...
	public MainMenu(SceneHandler sh)
	{
	...
	public void doneLoading()
	{
		...
		TextButton button1 = new TextButton("Exploration!", style);
		button1.addListener(new ClickListener()
		{
			@Override
			public void clicked(InputEvent event, float x, float y)
			{
				sHandler.reloadScene("game");
				sHandler.switchScene("game");
			}
		});
		table.add(button1);
		table.row();

		TextButton button2 = new TextButton("Escape!", style);
		table.add(button2);
		table.row();

		TextButton button3 = new TextButton("Training!", style);
		button3.addListener(new ClickListener()
		{
			@Override
			public void clicked(InputEvent event, float x, float y)
			{
				sHandler.reloadScene("training");
				sHandler.switchScene("training");
			}
		});
		table.add(button3);
